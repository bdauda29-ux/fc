      ...
      <section className="grid gap-6 xl:grid-cols-[360px_1fr]">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-500">
            Add new players at any time, then activate or deactivate them for future fixtures.
          </p>
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="text-sm text-slate-500">
                Track active status, league position, and profile access in one place.
              </p>
            </div>
                ...
                <tbody className="divide-y divide-slate-100">
                  {players.length === 0 ? (
                    ...
                    players.map((player) => {
                      ...
                      const boundToggle = togglePlayerStatus.bind(null, player.id, !player.isActive);
